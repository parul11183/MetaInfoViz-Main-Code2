            ...
            <div className=" w-full">
                ...
                <div className="content-con w-full">
                    ...
                    <div className="plot-con">
                        ...
                        <h2 className="text-xl font-semibold text-center">Centrality Measure</h2>
                        </div>
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            >
                                                ...
                                                <SelectContent>
                                                    ...
                                                    <SelectItem value="page-rank">Page Rank</SelectItem>
                                                </SelectContent>
                                            </Select>
                                        </div>
                                    </div>
...
export default CentralityMeasure;
