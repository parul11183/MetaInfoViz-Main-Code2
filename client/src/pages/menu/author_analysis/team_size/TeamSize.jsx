    ...
    const options = {
        ...
        plugins: {
            ...
            title: {
                ...
                text: 'Chart Title', // You can customize the title text as needed
            },
        },
        scales: {
            x: {
            ...
            <div className=" w-full">
                ...
                <div className="content-con w-full">
                    ...
                    <div className="plot-con">
                        ...
                        <h2 className="text-xl font-semibold text-center">Team Size</h2>
                        </div>
                                ...
                                <div className="tools-grid">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Select
                                                value={chartConfig.plotType}
                                                onValueChange={(value) => setChartConfig(prev => ({ ...prev, plotType: value }))}
                                            >
                                                <SelectTrigger className="h-8">
                                                    <SelectValue />
                                                </SelectTrigger>
                                                <SelectContent>
                                                    <SelectItem value="team-size-vs-papers">TeamSize Vs Papers</SelectItem>
                                                    <SelectItem value="pub-year-vs-avg-team-size">PubYear Vs. Avg TeamSize</SelectItem>
                                                </SelectContent>
                                            </Select>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-3">
                                        <div className="space-y-2">
                                            ...
                                            <Select
                                            // value={chartConfig.chartOrientation}
                                            // onValueChange={(value) => setChartConfig(prev => ({ ...prev, chartOrientation: value }))}
                                            >
                                                <SelectTrigger className="h-8">
