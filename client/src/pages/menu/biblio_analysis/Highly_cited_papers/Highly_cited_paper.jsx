  ...
  return (
    <MenuLayout>
      <div className=" w-full">
        {/* <h1 className="text-3xl font-bold mb-4">Citations Analysis</h1> */}

        <div className="content-con w-full">
          {/* Plot Container */}
          <div className="plot-con">
            <div className="plot-header">
            <h2 className="text-xl font-semibold text-center">Citation Analysis</h2>
            </div>
...
export default Highly_cited_paper;
