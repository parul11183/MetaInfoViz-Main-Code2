                ...
                <div className="content-con w-full">
                    ...
                    <div className="plot-con">
                        <div className="plot-header">
                            <h2 className="text-xl font-semibold text-center">Document Analysis</h2>
                        </div>
                    ...
                    <DropdownMenuContent>
                      ...
                      <DropdownMenuItem onClick={() => handleExport('csv')}>
                        CSV Data
                                    ...
                                    {/* <Button variant="outline" size="sm" className="flex-1" onClick={handleRefreshData}>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            >
                                                ...
                                                <SelectContent>
                                                    <SelectItem value="average">Horizontal</SelectItem>
                                                    <SelectItem value="cumulative">Vertical</SelectItem>
                                                </SelectContent>
                                            </Select>
                                        </div>
                                    </div>
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            >
                                                ...
                                                <SelectContent>
                                                    ...
                                                    <SelectItem value="authorKeywords">Author Keywords</SelectItem>
                                                </SelectContent>
                                            </Select>
                                        </div>
